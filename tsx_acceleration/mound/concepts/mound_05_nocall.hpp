/**
 *  Mound Refinement 5: Get rid of function calls to common code.
 */
 ...
 */
void fill_cavity_nocall(Node* N)
{
    ...
    while (true) {
        ...
        atomic {
            ...
            fill_cavity_nocall(N->right); continue;
        }
        catch (LeftCavity) {
            fill_cavity_nocall(N->left); continue;
        }
